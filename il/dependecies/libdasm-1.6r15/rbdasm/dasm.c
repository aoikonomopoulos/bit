...
//
// Returns the operands type as one of the Operand::Type
// constants.
//
...
void Init_dasm()
{
	...
	// Dasm
	dasm_klass = rb_define_class("Dasm", rb_cObject);
	...
	// Eflags constants
	rb_define_const(dasm_klass, "EFL_CF", INT2FIX(EFL_CF));
	rb_define_const(dasm_klass, "EFL_PF", INT2FIX(EFL_PF));
	rb_define_const(dasm_klass, "EFL_AF", INT2FIX(EFL_AF));
	rb_define_const(dasm_klass, "EFL_ZF", INT2FIX(EFL_ZF));
	rb_define_const(dasm_klass, "EFL_SF", INT2FIX(EFL_SF));
	rb_define_const(dasm_klass, "EFL_TF", INT2FIX(EFL_TF));
	rb_define_const(dasm_klass, "EFL_IF", INT2FIX(EFL_IF));
	rb_define_const(dasm_klass, "EFL_DF", INT2FIX(EFL_DF));
	rb_define_const(dasm_klass, "EFL_OF", INT2FIX(EFL_OF));

	// Register name and type constants
	tmp = rb_define_module_under(dasm_klass, "Register");

	rb_define_const(tmp, "EAX", INT2FIX(REG_EAX));
	rb_define_const(tmp, "AX",  INT2FIX(REG_AX));
	rb_define_const(tmp, "AL",  INT2FIX(REG_AL));
	rb_define_const(tmp, "ES",  INT2FIX(REG_ES));
	rb_define_const(tmp, "ECX", INT2FIX(REG_ECX));
	rb_define_const(tmp, "CX",  INT2FIX(REG_CX));
	rb_define_const(tmp, "CL",  INT2FIX(REG_CL));
	rb_define_const(tmp, "CS",  INT2FIX(REG_CS));
	rb_define_const(tmp, "EDX", INT2FIX(REG_EDX));
	rb_define_const(tmp, "DX",  INT2FIX(REG_DX));
	rb_define_const(tmp, "DL",  INT2FIX(REG_DL));
	rb_define_const(tmp, "SS",  INT2FIX(REG_SS));
	rb_define_const(tmp, "EBX", INT2FIX(REG_EBX));
	rb_define_const(tmp, "BX",  INT2FIX(REG_BX));
	rb_define_const(tmp, "BL",  INT2FIX(REG_BL));
	rb_define_const(tmp, "DS",  INT2FIX(REG_DS));
	rb_define_const(tmp, "ESP", INT2FIX(REG_ESP));
	rb_define_const(tmp, "SP",  INT2FIX(REG_SP));
	rb_define_const(tmp, "AH",  INT2FIX(REG_AH));
	rb_define_const(tmp, "FS",  INT2FIX(REG_FS));
	rb_define_const(tmp, "EBP", INT2FIX(REG_EBP));
	rb_define_const(tmp, "BP",  INT2FIX(REG_BP));
	rb_define_const(tmp, "CH",  INT2FIX(REG_CH));
	rb_define_const(tmp, "GS",  INT2FIX(REG_GS));
	rb_define_const(tmp, "ESI", INT2FIX(REG_ESI));
	rb_define_const(tmp, "SI",  INT2FIX(REG_SI));
	rb_define_const(tmp, "DH",  INT2FIX(REG_DH));
	rb_define_const(tmp, "EDI", INT2FIX(REG_EDI));
	rb_define_const(tmp, "DI",  INT2FIX(REG_DI));
	rb_define_const(tmp, "BH",  INT2FIX(REG_BH));

	tmp = rb_define_module_under(dasm_klass, "RegisterType");

	rb_define_const(tmp, "General", INT2FIX(REGISTER_TYPE_GEN));
	rb_define_const(tmp, "Segment", INT2FIX(REGISTER_TYPE_SEGMENT));
	rb_define_const(tmp, "Debug",   INT2FIX(REGISTER_TYPE_DEBUG));
	rb_define_const(tmp, "Control", INT2FIX(REGISTER_TYPE_CONTROL));
	rb_define_const(tmp, "Test",    INT2FIX(REGISTER_TYPE_TEST));
	rb_define_const(tmp, "XMM",     INT2FIX(REGISTER_TYPE_XMM));
	rb_define_const(tmp, "MMX",     INT2FIX(REGISTER_TYPE_MMX));
	rb_define_const(tmp, "FPU",     INT2FIX(REGISTER_TYPE_FPU));
	...
	rb_define_const(oper_type_klass, "Memory",    INT2FIX(OPERAND_TYPE_MEMORY));
	rb_define_const(oper_type_klass, "Registery", INT2FIX(OPERAND_TYPE_REGISTER));
	rb_define_const(oper_type_klass, "Immediate", INT2FIX(OPERAND_TYPE_IMMEDIATE));
}
